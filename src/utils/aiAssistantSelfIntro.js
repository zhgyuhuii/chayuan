...
const INTRO_WPS_FEATURES = [
  ...
  '如果你正在编辑文档，我还可以结合当前选区、全文上下文和常见文档操作链路给出更贴近现场的帮助。',
...
const FAQ_CAPABILITY_WPS = [
  ...
  '和普通网页聊天不同，这里更强调与文档上下文联动，所以很多结果可以继续落到文档里；例如 AI 痕迹检查会把疑似片段以批注形式锚在原文上，便于对照修改。',
...
const FAQ_EXPORT_DETAILS = [
  ...
  '不过具体可导出的范围和效果，仍要看当前文档里对象本身的类型以及应用环境对该对象的支持程度。'
]
