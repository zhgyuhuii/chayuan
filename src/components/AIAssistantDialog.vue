...
export default {
  ...
  computed: {
    ...
    assistantGroups() {
      ...
      const ORDER = [
        ...
        'eduadmin', 'school',
        'foreign', 'customs',
        'govfinance', 'govtax', 'govhrss', 'govcivil', 'govnatres', 'govhousing', 'govenviron', 'govagrirural', 'govcommerce', 'govcultour', 'govhealth', 'govmedicare', 'govmarketreg', 'govstats', 'govdevreform', 'govindustryit', 'govtransport', 'govwater', 'govforestry', 'govunitedfront', 'govarchive', 'govservicehall', 'govhotline', 'govorg', 'govpublicity', 'govdiscipline', 'govstaffing', 'govurbanmgmt', 'govaudit', 'prison', 'arbitration', 'forensic', 'notary', 'university', 'library', 'preschool', 'specialedu', 'voccollege', 'examboard', 'property', 'construction', 'securities', 'accounting', 'consulting', 'exhibition', 'aviation', 'railway', 'steel', 'textile', 'foodprocess', 'fresh', 'furniture', 'buildmaterial', 'meddevice', 'medbeauty', 'rehabilitation', 'fitness', 'arttraining', 'hotel', 'livestock', 'cdc', 'museum', 'costengineer', 'safetyprod', 'industrialpark', 'tradeassoc', 'assetappraisal', 'taxagent', 'hrservice', 'auction', 'union', 'cyleague', 'womensfed', 'disabledfed', 'partyschool'
      ]
      const rank = (k) => {
  ...
  methods: {
    ...
    resolveAssistantCategoryLabel(item) {
      const LABELS = ASSISTANT_GROUP_LABELS
