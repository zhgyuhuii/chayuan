...
const MODULES = {
  aizhushou: {
    ...
    dataSources: '所有 chayuan 模块(智库 / 办公 / 模型广场 / 智能空间 / 应用市场 / 训练中心 / 我的待办)+ 当前文档 / 选区 / 历史会话',
  ...
  shichang: {
    ...
    features: [
      ...
      '插件无处不在:可在察元AI加载项内 / 对话框内 / 独立页 / 工作流节点 调用',
  ...
  deploy_service: {
    ...
    features: [
      '1-2 台服务器跑 server,客户端任意连(察元AI加载项 / Web / Desktop)',
